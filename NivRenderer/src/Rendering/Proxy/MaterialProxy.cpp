...
TextureProxy** MaterialProxy::GetDiffuseTexture() { return &m_DiffuseTexture; }

TextureProxy** MaterialProxy::GetNormalTexture() { return &m_NormalTexture; }

TextureProxy** MaterialProxy::GetMetallicTexture() { return &m_MetallicTexture; }

TextureProxy** MaterialProxy::GetRoughnessTexture() { return &m_RoughnessTexture; }

TextureProxy** MaterialProxy::GetAOTexture() { return &m_AOTexture; }

TextureProxy** MaterialProxy::GetEmissiveTexture() { return &m_EmissiveTexture; }
